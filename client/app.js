...
razorApp.controller('razorController', function($scope, $http) {
    let usersData;
    $http({
        method: 'GET',
    ...
    $scope.images = [{ check: 'UI/UX', title: 'Provide your insights regarding the interface', result: 'Desing has no hierachy. \nSite could be Cleaner.\nThe branding of the site is simply not there. \nInformation gets lost to the eye' }, { check: 'Code', title: 'Identify a piece of code', result: 'Mixin from LESS css Preformater' }, { src: whatThis, check: 'Code', title: 'Identify a piece of code', result: 'Cute Picture of a cat' }];
